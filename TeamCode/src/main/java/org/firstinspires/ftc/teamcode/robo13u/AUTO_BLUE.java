...
public class AUTO_BLUE extends LinearOpMode {
    ...
    private final Pose bottomCollectPose = new Pose(25, 35, Math.toRadians(90));
    private final double waitBottomC = 2.5;
    private final Pose bottomShootPose = new Pose(45, 12, Math.toRadians(180));
    private final double waitBottomS = 1.45;
    ...
    private final Pose fourthShootPose = new Pose(47.5, 12, Math.toRadians(115));
    ...
    public void buildPaths() {
        bottomCollect = robot.follower.pathBuilder()
                .addPath(new BezierCurve(startPose, new Pose(25, 15), new Pose(25, 15), bottomCollectPose))
